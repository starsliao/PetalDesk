...
[产品网站](https://starsliao.github.io/PetalDesk/) · [GitHub](https://github.com/starsliao/PetalDesk) · [下载 Windows 安装包](https://github.com/starsliao/PetalDesk/releases/download/v0.3.1/PetalDesk_0.3.1_x64-setup.exe)
...
长截图的默认操作是：按 `F1` 框选固定区域，点击工具栏中的长截图按钮，保持“手动滚动”并点击选区内会滚动的正文；截图界面隐藏后，在 VS Code、浏览器或其他原窗口中滚动内容，完成时点击独立控制条中的对勾。VS Code 等普通窗口不需要安装浏览器扩展。
...
下载 [Windows x64 安装包](https://github.com/starsliao/PetalDesk/releases/download/v0.3.1/PetalDesk_0.3.1_x64-setup.exe) 后按向导操作。安装器会检查 WebView2；缺少时从微软官方地址显示进度并下载、静默安装，然后继续安装飞花 - PetalDesk。联网安装包因此更小。
