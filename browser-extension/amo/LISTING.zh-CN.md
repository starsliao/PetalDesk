...
- 用户名和密码权限为可选权限。用户在飞花中开启密码功能后，还必须点击 Firefox 工具栏中的飞花图标并接受 Firefox 的授权提示。
...
- Windows 安装包公开 URL：https://github.com/starsliao/PetalDesk/releases/download/v0.6.2/PetalDesk_0.6.2_x64-setup.exe
- 许可证：MIT
