...
连接本机飞花桌面应用，在 Firefox 中完成长截图，并按用户主动选择安全填充或保存站点账号密码。
...
- 只有用户在飞花或工具栏弹窗中主动选择账户后才会填充；扩展只填写字段，绝不自动提交表单。
...
- Windows 安装包公开 URL：https://github.com/starsliao/PetalDesk/releases/download/v0.7.4/PetalDesk_0.7.4_x64-setup.exe
- 许可证：MIT
